...
View Assist is easily extendable by adding custom sentences automations which provide data to different custom views.

To customize your dashboard views, choose view variants, or manage community and custom views directly from the Home Assistant UI, see the [Managing Views & Features Guide](managing-views.md).

On this page you will find a gallery of premade custom sentences blueprints. You will find links to the requirements and installation instructions. These blueprints have been made available for easy installation. You MUST use these to extend the base Home Assistant voice experience to fully utilize View Assist. Use these blueprints to create automations to fit your needs.
